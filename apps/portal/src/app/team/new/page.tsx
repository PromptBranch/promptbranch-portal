  ...
  return (
    <div className="min-h-screen bg-app text-ink">
      <main className="mx-auto max-w-md px-4 py-16">
        <Link href="/team" className="inline-flex items-center gap-1.5 text-sm text-ink-dim transition-colors hover:text-ink">
          <ArrowLeft size={14} aria-hidden /> Back to workspaces
        </Link>
